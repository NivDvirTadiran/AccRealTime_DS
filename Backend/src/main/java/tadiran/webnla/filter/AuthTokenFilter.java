...
public class AuthTokenFilter implements Filter {
    ...
    public void doFilter(ServletRequest servletRequest, ServletResponse servletResponse, FilterChain chain)
            ...
            if(     /* request.getRequestURI().startsWith("/accRealTime/") || */
                    request.getRequestURI().endsWith("/accRealTime/login") ||
                    request.getRequestURI().endsWith("/accRealTime/login.jsp") ||
                    request.getRequestURI().endsWith("/accRealTime/") ||
                    request.getRequestURI().startsWith("/accRealTime/js/tableMng.js") ||
                    request.getRequestURI().matches("\\/accRealTime\\/(?:title|main|index)\\.jsp$") ||
                    request.getRequestURI().endsWith("/accRealTime/") ||
            ...
            if (!valid) {
                    ...
                    /*response.setStatus(HttpServletResponse.SC_UNAUTHORIZED);
                    response.sendRedirect("/accRealTime/index.jsp");
                    return;*/
            }else {
