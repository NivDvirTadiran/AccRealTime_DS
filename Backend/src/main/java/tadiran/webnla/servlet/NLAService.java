...
public class NLAService extends HttpServlet {
	...
	private static Timer timer=new Timer("NLAService");
	...
	public void init (ServletConfig config) throws ServletException {
		...
		String ACCServerAddress1 = ctx.getInitParameter("ACCServerAddress1");
		String ACCServerAddress2 = ctx.getInitParameter("ACCServerAddress2");
		String ACCServerPort1 = ctx.getInitParameter("ACCServerPort1");
		String ACCServerPort2 = ctx.getInitParameter("ACCServerPort2");
		String ACCWebServers = ctx.getInitParameter("ACCWEBServers");
                String ACCVersion = ctx.getInitParameter("ACCVersion");
                int MaxAgentsInBriefReport = Integer.valueOf(ctx.getInitParameter("MaxAgentsInBriefReport"));
