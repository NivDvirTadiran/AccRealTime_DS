...
<html>
    ...
    <frameset id="main-page" rows="70,*" border="2">
            <frame name="title_md" src="title_md.jsp" noresize MARGINHEIGHT="0" MARGINWIDTH="5" SCROLLING="no"/>
            <frame id="mainwin_md" name="mainwin_md" src="main_md.jsp?md_ViewLevel=Company" MARGINWIDTH="0" MARGINHEIGHT="0"/>
    </frameset>
</html>
