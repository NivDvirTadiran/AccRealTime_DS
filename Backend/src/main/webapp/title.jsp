...
<%
        ...
        System.out.println("title.jsp(1) - Attribute Accept-Language " + langName);
%>
    ...
    <table border="0" cellpadding="0" cellspacing="0" width="100%">
        <tr>
            ...
            <td rowspan="2" align="left">
                <span style="font-size:15pt; font-weight:bold; ">Server Time </span>
                <span id="accServerTime" class="serverTime"><%=accServerTime%></span>
            </td>
        ...
        <tr>
            <td id="t1" align="right" valign="center" style="padding-bottom:3px; padding-right:5px; font-size:14px;">
                <span id="tools">
                    <%--select id="selectBox" name="lang" style="width:100px;" onchange="javascript:parent.mainwin.changeLang();javascript:parent.mainwin.restoreWS();javascript:setTimeout('location.reload();',1500);"--%>
                    <select id="selectBox" name="lang" style="width:130px;" onchange="javascript:parent.mainwin.changeLang();">
                    <%
                    ...
                    <span style="font-size:12px; color:#ddd;">&nbsp;|&nbsp;</span>
                    <a id="small" disabled class ="<%=smallClass%>" href="javascript:parent.mainwin.changeFrontSize('');javascript:parent.mainwin.restoreWS();" onClick="boldSmall()" style="font-size: 10px">A</a>
                    <a id="meduim" class ="<%=meduimClass%>" href="javascript:parent.mainwin.changeFrontSize('meduimSize');javascript:parent.mainwin.restoreWS();" onClick="boldMeduim()" style="font-size: 15px">A</a>
                    <a id="big" class ="<%=bigClass%>" href="javascript:parent.mainwin.changeFrontSize('bigSize');javascript:parent.mainwin.restoreWS();" onClick="boldBig()" style="font-size: 22px">A</a>
                    <span style="font-size:12px; color:#ddd;">&nbsp;|&nbsp;</span>
                    <a id="showDialog" href="javascript:parent.mainwin.showDialog('openDialog.jsp',350,300);" onClick="showDialog()" style="color:blue;" title='<nla:text message="tools.Open"/>'><img src="img/template.png" border="0" width="16" align="center"></a>
                    <a href="javascript:parent.mainwin.saveReport();" style="color:blue;" title='<nla:text message="tools.SaveAs"/>'><img src="img/save.png" border="0" width="16" align="center"></a> <span style="font-size:12px; color:#ddd;">&nbsp;|&nbsp;</span>
                    <a href="javascript:parent.mainwin.restoreWS();javascript:parent.mainwin.restoreLangFont(); javascript:location.reload();" style="color:blue;" title='<nla:text message="tools.RestoreWS"/>'><img src="img/reload_ws.gif" border="0" width="16" align="center"></a>
                    <a href="javascript:parent.mainwin.saveWS();" style="color:blue;" title='<nla:text message="tools.SaveWS"/>'><img src="img/save-ws.png" border="0" width="16" align="center"></a>
                    <c:if test="${sessionData.supLevel!=4}">
                        <a href="javascript:parent.mainwin.showDialog('loginManager.jsp',640,300);" style="color:blue;" title='<nla:text message="tools.LoginMng"/>'><img src="img/loginMng.png" border="0" width="16" align="center"></a> <span style="font-size:12px; color:#ddd;">&nbsp;|&nbsp;</span>
                    </c:if>
                    <a href="index_md.jsp" style="color:blue;" target="_parent" title='<nla:text message="tools.md"/>'><img src="img/dashboard.png" border="0" width="15" align="center"></a>
                    <span style="font-size:12px; color:#ddd;">&nbsp;|&nbsp;</span>
                </span>
    ...
    function update(input)
{
    ...
    function boldSmall() {
      ...
      function boldBig() {
          var test1 = parent.document.getElementById("mainwin");
